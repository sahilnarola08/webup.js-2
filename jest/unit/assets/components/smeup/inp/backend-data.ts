import { SmeupInputPanel } from "../../../../../../managers/converters-manager/declarations/data-structures/smeupInputPanel";
import { SmeupButtonArray } from "../../../../../../managers/converters-manager/declarations/data-structures/smeupButtonsArray";
...
export const createSimpleTable = (): SmeupInputPanel => {
  return {
    columns: [
      {
        code: "XXDAT1",
...
export const createSimpleButton = (): SmeupButtonArray => {
  return {
    buttons: [{ event: "click", id: "*ENTER", position: "BL", title: "Enter" }],
...
export const createSimpleLayout = (): SmeupLayout => {
  return {
    fmts: [{ attributes: { Nam: "SA", Txt: "Text" }, sections: [] }],
